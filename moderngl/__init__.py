...
class Context:
    ...
    def external_texture(
        ...
        return self.mglo.external_texture(glo, size, components, samples, dtype)
    ...
    def texture(
        ...
        *,
        ...
        return self.mglo.texture(size, components, data, samples, alignment, dtype, internal_format or 0)
    ...
    def texture_array(
        ...
        *,
        ...
        return self.mglo.texture_array(size, components, data, alignment, dtype)
    ...
    def texture3d(
        ...
        *,
        ...
        return self.mglo.texture3d(size, components, data, alignment, dtype)
    ...
    def texture_cube(
        ...
        *,
        ...
        return self.mglo.texture_cube(size, components, data, alignment, dtype, internal_format or 0)
    ...
    def depth_texture(
        ...
        *,
        ...
        return self.mglo.depth_texture(size, data, samples, alignment)
    ...
    def empty_framebuffer(
        ...
        return self.mglo.empty_framebuffer(size, layers, samples)
    ...
    def sampler(
        ...
        return self.mglo.sampler(repeat_x, repeat_y, repeat_z, filter, anisotropy, compare_func, border_color, min_lod, max_lod, texture)
